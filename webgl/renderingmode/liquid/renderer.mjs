export let renderer = {};
const vertexBufferShaderSourceCode = await loadShaderSource('/renderingmode/liquid/vertex.glsl');
const fragmentShaderBufferSourceCode = await loadShaderSource('/renderingmode/liquid/fragment.glsl');
...
renderer.renderGame = function (game, time, deltaTime)
{
    ...
    const dt = deltaTime;
    //from now on all drawing will be done on fbo2.fb
...

    {
        ...
        //draw the previous frame into the buffer as a backgound
        {
